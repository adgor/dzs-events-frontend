        ...
        <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
            ...
            <div>
              <a
                href="/"
                className="inline-flex items-center justify-center h-12 px-6 font-semibold tracking-wide text-teal-900 transition duration-200 bg-teal-400 rounded shadow-md hover:text-purple-900 hover:bg-purple-100 focus:shadow-outline focus:outline-none"
              >
                Get started
              </a>
            </div>
